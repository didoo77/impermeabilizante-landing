...
.social-chip{width:26px;height:26px;border-radius:50%;display:inline-grid;place-items:center;flex:0 0 26px;line-height:1;overflow:hidden}.social-chip svg{width:18px;height:18px;display:block}.wsp-chip{background:#25D366;color:#073016}.wsp-chip svg{fill:#073016}.ig-chip{background:radial-gradient(circle at 30% 110%,#fdf497 0%,#fdf497 13%,#fd5949 42%,#d6249f 62%,#285AEB 100%);color:#fff}.ig-chip svg{fill:none;stroke:#fff;stroke-width:2}.fb-chip{background:#1877F2;color:#fff;font-family:Arial,sans-serif;font-weight:900;font-size:19px}.btn-facebook{background:linear-gradient(135deg,#ffffff,#f4f8ff);border:1px solid rgba(24,119,242,.22);box-shadow:none;color:#0D2137}.btn-facebook:hover{box-shadow:0 16px 32px rgba(24,119,242,.14)}
.hero-card,.photo-stack{background:#f6fbfc!important;border-radius:28px;overflow:hidden}.hero-card img,.photo-main{object-fit:cover!important;object-position:center center!important;background:#f6fbfc!important}.footer-extra{width:100%;border-top:1px solid rgba(255,255,255,.10);margin-top:18px;padding-top:16px;display:flex;justify-content:space-between;gap:16px;flex-wrap:wrap;color:rgba(255,255,255,.48);font-size:12px;letter-spacing:.02em}.footer-credit{color:rgba(255,255,255,.55)}.footer-credit strong{color:rgba(255,255,255,.78);font-weight:700}
@media(max-width:900px){
  ...
  .hero{display:flex!important;flex-direction:column!important;gap:8px!important;min-height:auto!important;padding-top:13px!important;padding-bottom:22px!important;}
  .hero-copy{display:contents!important;}
  .hero-copy .eyebrow{order:1!important;text-align:center!important;margin:0 0 4px!important;font-size:9.5px!important;letter-spacing:.2em!important;}
  .hero-copy h1{order:2!important;font-size:clamp(29px,7.8vw,36px)!important;line-height:1.01!important;margin-bottom:5px!important;letter-spacing:-.048em!important;}
  .hero-copy .hero-lead{order:3!important;font-size:14px!important;line-height:1.34!important;margin-bottom:0!important;}
  .hero-visual{order:4!important;width:100%!important;margin:4px 0 0!important;}
  .hero-card{max-width:100%!important;margin:0!important;transform:none!important;border-radius:22px!important;aspect-ratio:16/9.8!important;background:#f6fbfc!important;}
  .hero-card img{width:100%!important;height:100%!important;object-fit:cover!important;object-position:center 43%!important;padding:0!important;}
  .hero-card:before{background:linear-gradient(135deg,rgba(255,255,255,.03),rgba(75,184,212,.03),rgba(245,166,35,.04))!important;}
  .hero-actions{order:5!important;margin:9px 0 7px!important;gap:8px!important;display:flex!important;flex-wrap:wrap!important;}
  .hero .hero-actions .btn-whatsapp{width:100%!important;min-height:46px!important;padding:10px 16px!important;font-size:15.5px!important;}
  .hero .hero-actions .btn-instagram,.hero .hero-actions .btn-facebook{width:calc(50% - 4px)!important;min-height:43px!important;padding:9px 10px!important;font-size:13.5px!important;}
  ...
  .social-chip{width:26px!important;height:26px!important;flex-basis:26px!important}.social-chip svg{width:18px!important;height:18px!important}.fb-chip{font-size:19px!important}
  ...
  .photo-main{width:100%!important;aspect-ratio:16/9.8!important;border-radius:22px!important;object-fit:cover!important;object-position:center 43%!important;}
...
@media(max-width:420px){
  ...
  .hero-card{aspect-ratio:16/9.8!important;}
}
`;
